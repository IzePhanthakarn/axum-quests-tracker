...
use crate::config::config_model::{
    AdventurersSecret, AppConfig, Database, GuildCommandersSecret, Server,
};
...
pub fn load() -> Result<AppConfig> {
    ...
    let adventurers_secret = AdventurersSecret {
        secret: env::var("JWT_ADVENTURER_SECRET")
            .context("JWT_ADVENTURER_SECRET is not set")?,
